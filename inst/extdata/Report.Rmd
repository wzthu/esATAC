...
go_data
```
For more GO information, please see data.frame file:`r go_path`
...
plot(CTCF_data, type = "l", col = "blue", lwd = 2, 
     xlab = "Relative Distance From Motif (bp)", ylab = "Cut Site Count", xaxt = "n", yaxt = "n")
