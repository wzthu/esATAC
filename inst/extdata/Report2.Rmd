...
library(VennDiagram)
library(grid)
PeakNumInCC <- comp_result$peakCom$getReportVal("venn.data")
...
```{r cols.print=3, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE}
motif_enrich.ctrl <- comp_result$mout$getReportVal("rdsOutput.peak2")
