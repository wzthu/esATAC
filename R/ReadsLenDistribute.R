ReadsLenDistribute <-R6Class(
  classname = "ReadsLenDistribute",
  inherit = BaseProc,
  public = list(
    initialize = function(atacProc,reportPrefix=NULL,bedInput=NULL,editable=FALSE){
      super$initialize("ReadsLenDistribute",editable,list(arg1=atacProc))
      if(!is.null(atacProc)){
    ...
    processing = function(){
        ...
        ggsave(paste0(private$paramlist[["reportPrefix"]],".lengthdistr.pdf"))
